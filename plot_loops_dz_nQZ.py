...
for i in range(1):
     ...
     cc = (chi2_f_no[(zp_f_no>zi)&(zp_f_no<zf)]/37.)
     ...
     c1 = ax[1].scatter(xx,yy,c=(cc),s=3.,cmap='jet',vmin=cc.min(),vmax=1.)
     clb = plt.colorbar(c1)
     ...
     cr = [Patch(facecolor='green',edgecolor='green',label='68% confidence',alpha=0.1),
       Patch(facecolor='red',edgecolor='red',label='95% confidence',alpha=0.1)]
