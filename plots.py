...
f,ax = plt.subplots(1,1,figsize=(7,6))
ax.plot(sigma_data,wp_rp_CODEX,'ko-',label='CODEX-LOWZ')
ax.set_xlabel(r'$r_p$')
ax.set_ylabel(r'$w_p$')
ax.set_xscale('log')
ax.set_yscale('log')
...
ax.set_yticks([1,2,3,5,10,20,30,50])
plt.tight_layout()
#plt.savefig('/cosma/home/dp004/dc-armi2/sdsswork/figures/November/GR_z0.3_xi2d_s40_pi40.png')
plt.show()